...
[![npm version](https://badge.fury.io/js/@gorlomi/mcphosting-cli.svg)](https://www.npmjs.com/package/@gorlomi/mcphosting-cli)
[![Downloads](https://img.shields.io/npm/dm/@gorlomi/mcphosting-cli.svg)](https://www.npmjs.com/package/@gorlomi/mcphosting-cli)
...
```bash
npm install -g @gorlomi/mcphosting-cli
...
4. **Proxy mode** — `npx @gorlomi/mcphosting-cli proxy <url>` bridges STDIO ↔ HTTP
...
- [GitHub](https://github.com/gorlomi-enzo/@gorlomi/mcphosting-cli)
